...
import az.talmir.weatherlogger.data.source.FakeDataSource
...
class ForecastsRepositoryTest {
    ...
    private val forecastData5 = Forecast(Constants.GOYCHAY_CITY_ID, "Goychay", R.drawable.goychay_pomegranate_city, 761, 9, 758, 65, 5.2f, 123456789, 987654321, Date())
