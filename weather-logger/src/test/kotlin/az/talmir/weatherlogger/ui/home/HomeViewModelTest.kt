...
import az.talmir.weatherlogger.CoroutineTestRule
import az.talmir.weatherlogger.R
import az.talmir.weatherlogger.data.FakeForecastRepository
import az.talmir.weatherlogger.getOrAwaitValue
...
class HomeViewModelTest {
    ...
    fun getForecastData_returnsNotNullValue() {
        ...
        val value = forecastsViewModel.getForecastData().getOrAwaitValue() //value
